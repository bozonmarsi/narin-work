...
export function WarehouseView() {
  ...
  return (
    <div className="flex h-[calc(100vh-100px)] gap-4">
      {/* Заказы — 2/3 экрана, всегда на виду */}
      <div className="w-full overflow-y-auto pb-20 md:w-2/3 md:pb-0">
        <OrdersView />
      </div>

      {/* Остальные разделы — 1/3 экрана, десктоп/планшет */}
      ...
      {/* Мобильный: нижняя панель, разделы открываются на весь экран */}
